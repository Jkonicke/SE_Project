...
public class EnglishGhost : MonoBehaviour
{
    ...
    {
        if (enter && !EnglishGhostInput.isCorrect)
        {
            ...
            SceneManager.LoadScene("EnglishGhostScene", LoadSceneMode.Additive);
            Debug.Log("entered - EnglishGhost");
        }
    }
    /*
    ...
    */
    ...
    {
        if (exit && !EnglishGhostInput.isCorrect)
        {
            SceneManager.UnloadSceneAsync("EnglishGhostScene");
            Debug.Log("exit - EnglishGhost");
        }
    }
}